...
func (c *version) Entitlement() EntitlementController {
	return NewEntitlementController(schema.GroupVersionKind{Group: "licensing.cattle.io", Version: "v1", Kind: "Entitlement"}, "entitlements", true, c.controllerFactory)
}
